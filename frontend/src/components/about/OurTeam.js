    ...
    async function GetTeam(){
        ...
        try{
            ...
            if(response.data.success){
                ...
                team_dispatch({type:"FETCH_SUCCESS",payload:[true,CollectionOfTeam(all_data)]})
          ...
          <Row className="team-row">
            <Col className="col-12">
              ...
              <div className="team-tree">
                  ...
                  {
                    team_state.data["collection0"]&&team_state.data["collection0"].map((data)=>{
                      return (
                        
                          <div className="team-head">
                            <div className="team-img" style={{backgroundImage:`url(${data.photo})`}}></div>
                  ...
                  column&&column.map((data,index)=>{
                     return(
                        ...
                        <div className="team-up-container">
                          {
                             team_state.data[`collection${data}`]&&team_state.data[`collection${data}`].map((data)=>{
                                return (
                                    ...
                                    <div className="team-post">{data.position}</div>
                                    </div>
                                    </div>
                                )
                             })
