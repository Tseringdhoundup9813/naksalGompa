          ...
          <Row className="my-4">
            <Col className="col-12 col-md-5 col-lg-4">
              <div className="founder-card-container">
                ...
                <div className="f-box-img" style={{backgroundImage:`url(${director_state.data[0]&&director_state.data[0].photo})`}}></div>
                <div className="f-box-right"></div>
              </div>
              <div className="founder-detail">
                <div className="founder-name">{director_state.data[0]&&director_state.data[0].name}</div>
            ...
            <Col className="col-12 col-md-7 col-lg-8">
              <div className="founder-main-detail">
                <div className="f-name text-capitalize">
                   {director_state.data[0]&&director_state.data[0].name}
                </div>
                <div className="f-para">
                {director_state.data[0]?parse(director_state.data[0].des):""}
